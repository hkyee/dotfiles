...
configure_prompt() {
    ...
    case "$PROMPT_ALTERNATIVE" in
        twoline)
            ...
            PROMPT=$'%F{%(#.blue.green)}${debian_chroot:+($debian_chroot)─}${VIRTUAL_ENV:+($(basename $VIRTUAL_ENV))}[%B%F{%(#.red.blue)}%(6~.%-1~/…/%4~.%5~)%b%F{%(#.blue.green)}]\n>%B%(#.%F{red}#.%F{blue})%b%F{reset} '
...
# ---- Snap Store ----
alias snap-store="snap run snap-store"
...
# ---- Wenum, a wfuzz fork ----
alias wenum=/home/herrken/.local/share/pipx/venvs/wenum/bin/wenum

# ---- Gobuster dir alias ----
alias gobusterDirbuster="gobuster dir -w /usr/share/dirbuster/wordlists/directory-list-lowercase-2.3-medium.txt -u $1"
...
export PATH=$PATH:/home/herrken/.spicetify
